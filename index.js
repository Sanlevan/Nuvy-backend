...
async function generatePassBuffer(client, boutique, clientRank, hostUrl) {
    ...
    const layout = {
            "headerFields": [{
                ...
                // On garde le changeMessage ici pour que la notif Push s'affiche toujours !
            ...
            "auxiliaryFields": [], // On le laisse vide par défaut
            "backFields": [
                {
                    "key": "adresse",
        ...
        // 🎁 NOUVEAU : Affichage conditionnel des cadeaux sur le devant
